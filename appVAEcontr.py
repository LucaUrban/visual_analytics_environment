    ...
    if widget == "Consistency checks":
        ...
        if methodology == 'Ratio analysis':
            ...
            if cat_sel_col == '-':
                ...
                list_prob_cases = [[con_checks_feature, list_countries[j], list_un_cat[i], f'{round(tab_per[i, j], 2)}%', f'{DV_fin_res[i, j]}/{tab_abs[i, j]}'] if i < len(list_un_cat)-3 or j < len(list_countries)-1
