...
if demo_data_radio == 'Demo datset' or uploaded_file is not None:
    ...
    if widget == "Ratios Analysis":
        ...
        if cou_sel == 'All ids':
            if ratio_vio_sel2 == '-':
                fig_vio = px.violin(table, y = new_ratio_name, box = True, points = 'suspectedoutliers', title = 'Violin plot for the created ratio', hover_data = table[ratio_vio_sel1])
            else:
                ...
                fig_vio = px.violin(table, y = new_ratio_name, color = table[ratio_vio_sel2], box = True, points = 'suspectedoutliers', 
                                    title = 'Violin plot for the created ratio', hover_data = table[ratio_vio_sel1])
        else:
            if ratio_vio_sel2 == '-':
                ...
                fig_vio = px.violin(table[table[ratio_vio_sel1] == cou_sel], y = new_ratio_name, x = ratio_vio_sel1, color = table[table[ratio_vio_sel1] == cou_sel][ratio_vio_sel2], 
                                    box = True, points = 'suspectedoutliers', title = 'Violin plot for the created ratio', hover_data = table[ratio_vio_sel1])
